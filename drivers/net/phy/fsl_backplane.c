...
#define TRAIN_ALGORITHM_VERSION	"v1.4.34"
 ...
 */
#define ENABLE_LESS_HAPPY_2_IS_HAPPY
#define ENABLE_EVEN_LESS_HAPPY_3_IS_HAPPY
...
#ifdef ENABLE_LESS_HAPPY_2_IS_HAPPY
	bool rx_happy_21, rx_happy_22;
	u8 full_gaink = xgkr->srds->get_full_gaink2();
#endif //ENABLE_LESS_HAPPY_2_IS_HAPPY
#ifdef ENABLE_EVEN_LESS_HAPPY_3_IS_HAPPY
	bool rx_happy_31, rx_happy_32;
	bool is_ok;
#endif //ENABLE_EVEN_LESS_HAPPY_3_IS_HAPPY
...
static int is_ld_valid(struct xgkr_params *xgkr, u32 *ld_coe)
{
	...
	/* to be removed: what is this HW restriction ?
